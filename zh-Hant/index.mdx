---
title: "在 iPhone 上查看 AI 狀態、用量與即時 session"
sidebarTitle: "Nomo"
...
Nomo 是一款 iPhone App，為那些工作仰賴編碼代理、卻沒辦法整天盯著它的人而做。
...
<CardGroup cols={2}>
  ...
  <Card title="Sessions" href="/zh-Hant/sessions/overview" icon="mobile-screen">
    在鎖定畫面上看著 Claude Code、Codex 和 OpenCode 跑，也直接在那裡回覆它們的權限請求。
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="安裝App" href="/zh-Hant/installation" icon="apple">
    到 App Store 下載 Nomo。
  </Card>
