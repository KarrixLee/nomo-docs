...
sidebarTitle: "Nomo"
description: "Nomo 替你在 iPhone 上盯着编程智能体 —— 服务状态、套餐用量，以及可以随手答复的实时会话。"
---

import { Screens } from "/snippets/screens.jsx";

Nomo 是一款 iPhone 应用，写给那些工作离不开编程智能体、却又没法整天守着它的人。
...
<CardGroup cols={2}>
  <Card title="状态与用量" href="/zh-Hans/status-usage" icon="signal">
    覆盖五家服务商的主屏幕小组件；服务出故障、或者额度快见底时会通知你。免费。
  </Card>
  <Card title="会话" href="/zh-Hans/sessions/overview" icon="mobile-screen">
    在锁定屏幕上看着 Claude Code、Codex 和 OpenCode 干活，并直接在那里答复它们的权限请求。
  </Card>
</CardGroup>
