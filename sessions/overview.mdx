...
keywords: ["Nomo", "Claude Code", "Codex", "iPhone", "session", "computer", "Dynamic Island", "permission", "pairing", "Overview"]
---
...
<script type="application/ld+json" dangerouslySetInnerHTML={{__html: JSON.stringify(
{
  ...
  "description": "Watch Claude Code and Codex sessions from your iPhone on the Lock Screen and Dynamic Island, and answer their permission prompts remotely.",
  "offers": {
    "@type": "Offer",
    "price": "0",
    "priceCurrency": "USD"
