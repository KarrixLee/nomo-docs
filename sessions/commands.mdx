...
session on the computer you want to affect — a slash command in Claude Code, a
`$` skill in Codex.
...
| --- | --- | --- |
| <a href="#pair">Pair this computer <Icon icon="link" size={11} /></a> | `/nomo-cc:pair` | `$nomo-pair` |
| <a href="#status">Check health <Icon icon="link" size={11} /></a> | `/nomo-cc:status` | `$nomo-status` |
| <a href="#approvals">Pause or resume approvals <Icon icon="link" size={11} /></a> | `/nomo-cc:approvals` | `$nomo-approvals` |
| <a href="#reset">Clear stuck sessions <Icon icon="link" size={11} /></a> | `/nomo-cc:reset` | `$nomo-reset` |
| <a href="#unpair">Disconnect this computer <Icon icon="link" size={11} /></a> | `/nomo-cc:unpair` | `$nomo-unpair` |
...
<ResponseField name="Codex plugin">
  ...
  people — see [Codex differences](/sessions/codex#hooks-have-to-be-trusted).
</ResponseField>
