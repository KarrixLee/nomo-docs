...
icon: "sliders"
keywords: ["Nomo", "Claude Code", "Codex", "OpenCode", "iPhone", "session", "computer", "Dynamic Island", "permission", "pairing", "Settings"]
---
...
It starts **on**, so this switch is the only one you have to turn on — there is
nothing to enable on your computer.
